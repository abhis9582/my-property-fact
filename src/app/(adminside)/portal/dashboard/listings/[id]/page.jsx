...
export default function ListingDetailPage() {
    ...
    return (
      <div className="portal-content">
        <Alert variant="danger">
          ...
          <p>{error}</p>
          <Button variant="outline-danger" size="sm" onClick={() => router.push('/portal/dashboard/listings')}>
            Back to Listings
          </Button>
        </Alert>
      </div>
  ...
  const formatArea = (area) => {
    if (area === null || area === undefined || area === "") return "Not specified";
  ...
  const getImageUrl = (imageUrl) => {
    ...
    if (cleanImageUrl.match(/^[A-Za-z]:[\/\\]/) || (cleanImageUrl.startsWith('/') && !cleanImageUrl.startsWith('/get/'))) {
        ...
        <div className="portal-card-header">
          <div className="d-flex justify-content-between align-items-center">
            <div>
              ...
              <p className="text-muted mb-0">View your property listing information</p>
            </div>
            <div className="d-flex gap-2">
              ...
              <Button 
                variant="primary"
                onClick={() => router.push(`/portal/dashboard/listings/${listingId}?action=edit`)}
              >
                Edit Property
              </Button>
            </div>
                  ...
                  {listing.imageUrls.map((imageUrl, index) => {
                    ...
                    return fullImageUrl ? (
                      <Col key={index} md={4} sm={6} className="mb-3">
                        <div className="position-relative" style={{ height: '200px', overflow: 'hidden', borderRadius: '8px' }}>
                          <NextImage
                            src={fullImageUrl}
          ...
          <Row>
            <Col md={8}>
              <Card className="mb-4">
                ...
                <Card.Body>
                  ...
                  <Row className="mb-3">
                    <Col sm={4}><strong>Listing Type:</strong></Col>
                    <Col sm={8}>{listing.listingType || 'N/A'}</Col>
                  </Row>
                  <Row className="mb-3">
                    <Col sm={4}><strong>Transaction Type:</strong></Col>
                    <Col sm={8}>{listing.transaction || 'N/A'}</Col>
                  </Row>
                  <Row className="mb-3">
                    <Col sm={4}><strong>Sub Type:</strong></Col>
              ...
              <Card className="mb-4">
                ...
                <Card.Body>
                  <Row className="mb-3">
                    <Col sm={4}><strong>Project Name:</strong></Col>
                    <Col sm={8}>{listing.projectName || 'N/A'}</Col>
                  </Row>
                  <Row className="mb-3">
                    <Col sm={4}><strong>Builder:</strong></Col>
                  ...
                  <Row className="mb-3">
                    <Col sm={4}><strong>Locality:</strong></Col>
                  ...
                  <Row className="mb-3">
                    <Col sm={4}><strong>Carpet Area:</strong></Col>
                    <Col sm={8}>{formatArea(listing.carpetArea)}</Col>
                  </Row>
                  <Row className="mb-3">
                    <Col sm={4}><strong>Built-up Area:</strong></Col>
                    <Col sm={8}>{formatArea(listing.builtUpArea)}</Col>
                  </Row>
                  <Row className="mb-3">
                    <Col sm={4}><strong>Super Built-up Area:</strong></Col>
              ...
              <Card className="mb-4">
                ...
                <Card.Body>
                  <Row className="mb-3">
                    <Col sm={4}><strong>Bedrooms:</strong></Col>
                    <Col sm={8}>{listing.bedrooms || 'N/A'}</Col>
                  </Row>
                  <Row className="mb-3">
                    <Col sm={4}><strong>Bathrooms:</strong></Col>
                    <Col sm={8}>{listing.bathrooms || 'N/A'}</Col>
                  </Row>
                  <Row className="mb-3">
                    <Col sm={4}><strong>Balconies:</strong></Col>
                    <Col sm={8}>{listing.balconies || 'N/A'}</Col>
                  </Row>
                  <Row className="mb-3">
                    <Col sm={4}><strong>Floor Number:</strong></Col>
                    <Col sm={8}>{listing.floorNumber || 'N/A'}</Col>
                  </Row>
                  <Row className="mb-3">
                    <Col sm={4}><strong>Total Floors:</strong></Col>
                    <Col sm={8}>{listing.totalFloors || 'N/A'}</Col>
                  </Row>
                  <Row className="mb-3">
                    <Col sm={4}><strong>Facing:</strong></Col>
                    <Col sm={8}>{listing.facing || 'N/A'}</Col>
                  </Row>
                  <Row className="mb-3">
                    <Col sm={4}><strong>Furnished:</strong></Col>
                    <Col sm={8}>{listing.furnished || 'N/A'}</Col>
                  </Row>
                  <Row className="mb-3">
                    <Col sm={4}><strong>Parking:</strong></Col>
                    <Col sm={8}>{listing.parking || 'N/A'}</Col>
                  </Row>
                  {listing.features && listing.features.length > 0 && (
                    <Row className="mb-3">
                      <Col sm={4}><strong>Features:</strong></Col>
                      <Col sm={8}>
                        <ul>
            ...
            <Col md={4}>
              <Card className="mb-4">
                ...
                <Card.Body>
                  <Row className="mb-3">
                    <Col sm={6}><strong>Total Price:</strong></Col>
                    <Col sm={6} className="text-primary">
                      <strong>{formatPrice(listing.totalPrice)}</strong>
                    </Col>
                  </Row>
                  <Row className="mb-3">
                    <Col sm={6}><strong>Price per Sqft:</strong></Col>
                    <Col sm={6}>{listing.pricePerSqft ? `₹${listing.pricePerSqft.toLocaleString('en-IN')}` : 'N/A'}</Col>
                  </Row>
                  <Row className="mb-3">
                    <Col sm={6}><strong>Maintenance:</strong></Col>
                    <Col sm={6}>{listing.maintenanceCharges ? `₹${listing.maintenanceCharges.toLocaleString('en-IN')}` : 'N/A'}</Col>
                  </Row>
                  <Row className="mb-3">
                    <Col sm={6}><strong>Booking Amount:</strong></Col>
                    <Col sm={6}>{listing.bookingAmount ? `₹${listing.bookingAmount.toLocaleString('en-IN')}` : 'N/A'}</Col>
                  </Row>
                </Card.Body>
              </Card>
              ...
              <Card className="mb-4">
                ...
                <Card.Body>
                  <Row className="mb-3">
                    <Col sm={6}><strong>Contact Name:</strong></Col>
                  ...
                  <Row className="mb-3">
                    <Col sm={6}><strong>Preferred Time:</strong></Col>
              ...
              <Card className="mb-4">
                ...
                <Card.Body>
                  <Row className="mb-3">
                    <Col sm={6}><strong>Created:</strong></Col>
                    <Col sm={6}>
                      {listing.createdAt ? new Date(listing.createdAt).toLocaleDateString() : 'N/A'}
                    </Col>
                  </Row>
                  <Row className="mb-3">
                    <Col sm={6}><strong>Last Updated:</strong></Col>
                    <Col sm={6}>
