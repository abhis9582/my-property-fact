  ...
  return (
    ...
    <nav id="sidebar">
      ...
      <ul className="list-unstyled components">
        ...
        <li className={isActive("/admin/dashboard/property-approvals") ? "active" : ""}>
          <Link href="/admin/dashboard/property-approvals" onClick={handleLinkClick}>Property Approvals</Link>
        </li>
        <li className={isActive("/admin/dashboard/manage-users") ? "active" : ""}>
          <Link href="/admin/dashboard/manage-users" onClick={handleLinkClick}>Manage Users</Link>
        </li>
        <li className={activeDropdown === "dropdown3" || isDropdownActive([
          "/admin/dashboard/manage-countries",
          "/admin/dashboard/manage-states",
          "/admin/dashboard/manage-cities",
          "/admin/dashboard/manage-localities",
        ...
        <li className={activeDropdown === "dropdown1" || isDropdownActive([
          "/admin/dashboard/aminities",
          "/admin/dashboard/manage-features",
          "/admin/dashboard/manage-location-benefits",
          "/admin/dashboard/project-amenity",
          ...
          <ul
            className={`collapse list-unstyled ms-4 ${
              activeDropdown === "dropdown1" || isDropdownActive([
                "/admin/dashboard/aminities",
                "/admin/dashboard/manage-features",
                "/admin/dashboard/manage-location-benefits",
                "/admin/dashboard/project-amenity",
        ...
        <li className={isActive("/admin/dashboard/manage-projects") ? "active" : ""}>
          <Link href="/admin/dashboard/manage-projects" onClick={handleLinkClick}>Manage Projects</Link>
        </li>
        <li className={activeDropdown === "dropdown2" || isDropdownActive([
          "/admin/dashboard/city-price-data",
          "/admin/dashboard/manage-insight-headers",
          "/admin/dashboard/insight-category",
          "/admin/dashboard/top-developers"
          ...
          <ul
            className={`collapse list-unstyled ms-4 ${
              activeDropdown === "dropdown2" || isDropdownActive([
                "/admin/dashboard/city-price-data",
                "/admin/dashboard/manage-insight-headers",
                "/admin/dashboard/insight-category",
                "/admin/dashboard/top-developers"
          ...
          >
            <li className={isActive("/admin/dashboard/city-price-data") ? "active" : ""}>
              <Link href="/admin/dashboard/city-price-data" onClick={handleLinkClick}>
                City Price Data
              </Link>
            </li>
            <li className={isActive("/admin/dashboard/manage-insight-headers") ? "active" : ""}>
              <Link href="/admin/dashboard/manage-insight-headers" onClick={handleLinkClick}>
                Manage Headers
              </Link>
            </li>
            <li className={isActive("/admin/dashboard/insight-category") ? "active" : ""}>
              <Link href="/admin/dashboard/insight-category" onClick={handleLinkClick}>
                Manage Insight Category
              </Link>
            </li>
            <li className={isActive("/admin/dashboard/top-developers") ? "active" : ""}>
        ...
        <li className={activeDropdown === "dropdown4" || isDropdownActive([
          "/admin/dashboard/manage-blogs",
          "/admin/dashboard/manage-categories"
        ]) ? "active" : ""}>
          <Link
          ...
          <ul
            className={`collapse list-unstyled ms-4 ${
              activeDropdown === "dropdown4" || isDropdownActive([
                "/admin/dashboard/manage-blogs",
                "/admin/dashboard/manage-categories"
              ]) ? "show" : ""
            }`}
          >
            <li className={isActive("/admin/dashboard/manage-blogs") ? "active" : ""}>
              <Link href="/admin/dashboard/manage-blogs" onClick={handleLinkClick}>Manage Blogs</Link>
            </li>
            <li className={isActive("/admin/dashboard/manage-categories") ? "active" : ""}>
        ...
        <li className={activeDropdown === "dropdown5" || isDropdownActive([
          "/admin/dashboard/web-story-category",
          "/admin/dashboard/web-story"
        ]) ? "active" : ""}>
          <Link
          ...
          <ul
            className={`collapse list-unstyled ms-4 ${
              activeDropdown === "dropdown5" || isDropdownActive([
                "/admin/dashboard/web-story-category",
                "/admin/dashboard/web-story"
              ]) ? "show" : ""
            }`}
          >
            <li className={isActive("/admin/dashboard/web-story-category") ? "active" : ""}>
              <Link href="/admin/dashboard/web-story-category" onClick={handleLinkClick}>
                Web Story category
              </Link>
            </li>
            <li className={isActive("/admin/dashboard/web-story") ? "active" : ""}>
